...
# can differ from _SESSION_PROFILE when profile_routes sends one shared bot's
# chat to another runtime namespace (for example default's Telegram bot ->
# daily). Kanban subscriptions use this owner to select the sending adapter.
